  ...
  <div className='homeContent'>
    ...
    <main className={mainContentClass}>
      ...
      <h2 className='homeH2'>W</h2>
        ...
        <p className='introduction'>As a full stack web developer, I'm passionate about creating innovative solutions to real-world problems.<br/> I have a strong foundation in both front-end and back-end development, and I thrive in collaborative environments where I can work with other creative minds.</p>
    </main>
